...
### **Volatility models**
  ...
  - **Heston stochastic volatility**
    ...
    Calibration of Heston parameters to market implied volatility smiles/surfaces is **not** the primary focus of the project. Instead, it is illustrated separately in a dedicated Jupyter notebook (section doc), which shows how to fit \((\kappa, \theta, \xi, \rho, v_0)\).
